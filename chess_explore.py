...
background = pygame.image.load("chess.png")  # Make sure you have an image file
...
locations = [
    {"name": "A", "event": "Those who know to defend themselves defend under 9 levels of earth covered with mud and dust", "x": 350, "y": 450},
    {"name": "B", "event": "Those who know to attack, attack from the sky fast like a thunder", "x": 450, "y": 500},
    {"name": "C", "event": "in difficult ground we go back", "x": 380, "y": 280},
    {"name": "D", "event": "on enigmatic diverse ground we move cautiously making allies", "x": 350, "y": 280},
]
...
def game_loop():
    ...
    while running:
        ...
        draw_text("chess - EXPLORE", 50, 50, NEON_BLUE)
